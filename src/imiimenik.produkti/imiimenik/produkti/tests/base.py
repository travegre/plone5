...
def setup_product():
    ...
    import imiimenik.produkti
    zcml.load_config('configure.zcml', imiimenik.produkti)
    ...
    ztc.installPackage('imiimenik.produkti')
...
setup_product()
ptc.setupPloneSite(products=['imiimenik.produkti'])
