...
def setup_product():
    ...
    import dezurstva.produkti
    zcml.load_config('configure.zcml', dezurstva.produkti)
    ...
    ztc.installPackage('dezurstva.produkti')
...
setup_product()
ptc.setupPloneSite(products=['dezurstva.produkti'])
