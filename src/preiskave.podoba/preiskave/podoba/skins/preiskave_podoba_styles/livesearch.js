var livesearch = function (){
    ...
    function _searchfactory($form, $inputnode) {
        ...
        function _search() {
            ...
            if (jQuery('select.podrocje_select option:selected')[0]) var $$query = { q: $inputnode.value + '+' + jQuery('select.podrocje_select option:selected')[0].value};
            else var $$query = { q: $inputnode.value };
