...
def setup_product():
    ...
    import preiskave.produkti
    zcml.load_config('configure.zcml', preiskave.produkti)
    ...
    ztc.installPackage('preiskave.produkti')
...
setup_product()
ptc.setupPloneSite(products=['preiskave.produkti'])
