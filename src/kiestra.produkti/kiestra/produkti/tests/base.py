...
def setup_product():
    ...
    import kiestra.produkti
    zcml.load_config('configure.zcml', kiestra.produkti)
    ...
    ztc.installPackage('kiestra.produkti')
...
setup_product()
ptc.setupPloneSite(products=['kiestra.produkti'])
